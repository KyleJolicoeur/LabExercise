...
public class ShuffleGui extends Frame implements ActionListener
{
    ...
    public ShuffleGui()
    {
        tfCardFaceValue1.setEditable(false);
        tfCardFaceValue2.setEditable(false);
        tfCardFaceValue3.setEditable(false);
        tfCardFaceValue4.setEditable(false);
        tfCardFaceValue5.setEditable(false);
        tfCardSuit1.setEditable(false);
        tfCardSuit2.setEditable(false);
        tfCardSuit3.setEditable(false);
        tfCardSuit4.setEditable(false);
        tfCardSuit5.setEditable(false);
        tfPlayers.setEditable(false);
        
        tfCardFaceValue1.setFocusable(false);
        tfCardFaceValue2.setFocusable(false);
        tfCardFaceValue3.setFocusable(false);
        tfCardFaceValue4.setFocusable(false);
        tfCardFaceValue5.setFocusable(false);
        tfCardSuit1.setFocusable(false);
        tfCardSuit2.setFocusable(false);
        tfCardSuit3.setFocusable(false);
        tfCardSuit4.setFocusable(false);
        tfCardSuit5.setFocusable(false);
        tfPlayers.setFocusable(false);
        int iCounter=0;
        while(iCounter == 0)
        {
        ...
        add(new Label("and Dealer v0.3.1"));
        add(new Label("                                    "));
